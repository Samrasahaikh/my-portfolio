    ...
    <div className="min-h-screen bg-pink-200 flex items-center justify-center p-6 md:p-20 ">
      <div className="bg-white shadow-xl shadow-pink-900 rounded-lg max-w-2xl w-full p-6 md:p-10 transform transition-transform duration-500 ease-in-out hover:scale-110 animate-fadeIn">
        ...
        <div className="flex justify-center space-x-6 mt-8 text-pink-700 text-2xl">
          ...
          <a href="https://linkedin.com/in/samra-shaikh-7164142b6" target="_blank" className="hover:text-pink-500 transform transition-transform duration-500 ease-in-out hover:scale-110 animate-fadeIn"><FaLinkedin /></a>
          <a href="https://github.com/Samrasahaikh" target="_blank" className="hover:text-pink-500 transform transition-transform duration-500 ease-in-out hover:scale-110 animate-fadeIn"><FaGithub /></a>
          <a href="https://facebook.com/samra.shaikh.14289" target="_blank" className="hover:text-pink-500 transform transition-transform duration-500 ease-in-out hover:scale-110 animate-fadeIn"><FaFacebook /></a>
        </div>
      </div>
    </div>
  );
