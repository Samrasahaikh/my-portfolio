...
export default function Hero() {
  ...
  // components/Hero.tsx
    ...
    <section className="h-screen min-h-screen flex flex-col-reverse md:flex-row items-center justify-between px-4 md:px-8 max-w-screen-2xl"
    style={{ backgroundImage: "url('/bg2.jpg')",backgroundSize: "cover" }}>
      ...
      {/* Left section with image */}
        ...
        <Image 
          ...
          width={300}
          height={300}
          className="w-80 h-80 md:w-80 md:h-80 object-center rounded-full border-4 border-pink-800 mb-10 mt-8 md:mb-0
